...
export default function Patients() {
    ...
    const [selectedDifficulty, setSelectedDifficulty] = useState(1); // TODO: Pull from MongoDB
    ...
    if (error) {
        return <Text style={styles.error}>Error loading patients: {error.message}</Text>;
    }
